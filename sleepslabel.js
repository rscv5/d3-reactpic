...
var path_dir = './SC4002E0/0_frame.json';
const channels_dic = {
    '1st_channel': {
        name: 'EEG Fpz-Cz',
        svg_name: '#first_svg',
...
class D3line extends React.Component{
        ...
        document.addEventListener('keyup', (e)=> {
            ...
            switch(e.keyCode){
                ...
                case 87:{
                    ...
                    frame_label[now_n] = {itemID:now_n+1, itemLabel:'w'};
                    console.log('frame_label',frame_label);
                }
                 // case
                default:break;
            }
    ...
    showLine=()=> {
        ...
        tofileCsv=()=>{
            ...
            FileSaver.saveAs(blob,'sleepslabel.csv')
    ...
    render(){
        ...
        if(this.state.frame_data[0]!==undefined){
            ...
            //  this.Line(channels_dic['2nd_channel'].svg_name,this.state.frame_data[1],channels_dic['2nd_channel'].name);
        }
        // if(this.state.frame_data!==[]){this.showLine();}
            return(
                <Layout>
                <Layout>
                    <Button onClick={this.tofileCsv}>Done</Button>
                </Layout>
